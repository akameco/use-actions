...
[![Build Status](https://travis-ci.com/akameco/use-actions.svg?branch=master)](https://travis-ci.com/akameco/use-actions)
...
```
$ npm install @akameco/use-actions
$ yarn add @akameco/use-actions
```
